...
export function createSupabaseBrowserClient() {
  ...
  if (!url || !anonKey) {
    if (typeof window !== "undefined") {
      console.warn("NOTICE: NEXT_PUBLIC_SUPABASE_URL or NEXT_PUBLIC_SUPABASE_ANON_KEY missing in browser environment.");
    }
  }

  return createBrowserClient(
    url || "https://omnigrc-blog-placeholder.supabase.co",
