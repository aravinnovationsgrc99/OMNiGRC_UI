...
export const PageHero: React.FC<PageHeroProps> = ({
  ...
  return (
    <section className={`relative bg-[#0A111F] pt-28 sm:pt-36 pb-16 sm:pb-24 border-b border-navy-700/60 overflow-hidden ${className}`}>
      ...
      <div className="relative z-10 w-full max-w-7xl 2xl:max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-6">
            <div
              className="relative rounded-3xl border border-teal/30 bg-navy-900/90 p-4 sm:p-6 shadow-2xl backdrop-blur-xl overflow-hidden transition-all duration-300 hover:border-teal/50"
              style={accentColor ? { borderColor: `${accentColor}50` } : undefined}
            >
              {/* Soft Inner Glow Header Bar */}
              <div aria-hidden="true" className="flex items-center justify-between border-b border-navy-700/60 pb-3 mb-4">
