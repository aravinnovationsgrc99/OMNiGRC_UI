        ...
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-6 text-xs border-t border-slate-200/20 dark:border-navy-700/60 mt-8">
          ...
          <div className="flex items-center gap-3" aria-label="Official Social Media Links">
            ...
            <a
              ...
              className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-slate-200/80 dark:bg-navy-800 flex items-center justify-center text-slate-700 dark:text-slate-300 hover:text-[#FF0000] dark:hover:text-[#FF0000] hover:bg-white dark:hover:bg-navy-700 transition-all focus:outline-none focus:ring-2 focus:ring-[#F15E1C] shrink-0"
            >
            ...
            <a
              ...
              className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-slate-200/80 dark:bg-navy-800 flex items-center justify-center text-slate-700 dark:text-slate-300 hover:text-[#E4405F] dark:hover:text-[#E4405F] hover:bg-white dark:hover:bg-navy-700 transition-all focus:outline-none focus:ring-2 focus:ring-[#F15E1C] shrink-0"
            >
              <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <a
              ...
              className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-slate-200/80 dark:bg-navy-800 flex items-center justify-center text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-white dark:hover:bg-navy-700 transition-all focus:outline-none focus:ring-2 focus:ring-[#F15E1C] shrink-0"
            >
            ...
            <a
              ...
              className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-slate-200/80 dark:bg-navy-800 flex items-center justify-center text-slate-700 dark:text-slate-300 hover:text-[#0A66C2] dark:hover:text-[#0A66C2] hover:bg-white dark:hover:bg-navy-700 transition-all focus:outline-none focus:ring-2 focus:ring-[#F15E1C] shrink-0"
            >
              <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24" aria-hidden="true">
