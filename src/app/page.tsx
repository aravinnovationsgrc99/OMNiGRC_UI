...
<section className="w-full bg-white dark:bg-[#0A111F] px-4 md:px-8 py-16 md:py-24">
<div className="max-w-7xl mx-auto">
<div className="relative bg-teal-100 dark:bg-teal-900/40/25 rounded-2xl p-8 md:p-12 shadow-lg overflow-hidden">
{/*  Subtle background glow  */}
<div className="absolute -right-20 -bottom-20 w-80 h-80 bg-teal-600 dark:bg-teal-500/10 rounded-full blur-3xl pointer-events-none"></div>
<div className="max-w-3xl">
<div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white dark:bg-[#0A111F] text-teal-600 dark:text-teal-400 font-mono text-xs font-bold uppercase tracking-wider mb-4 shadow-sm">
<Zap className="h-5 w-5 shrink-0" />
            READY FOR AUDIT DAY
          </div>
<h2 className="text-4xl text-slate-900 dark:text-white font-bold tracking-tight">
            Connect your risk, assets, and controls today.
          </h2>
<p className="text-lg text-slate-600 dark:text-slate-300 font-medium mt-4 mb-8 leading-relaxed">
...
<a className="inline-flex items-center justify-center px-6 py-3.5 rounded-lg text-sm font-semibold text-slate-900 dark:text-white bg-white dark:bg-[#0A111F] hover:bg-slate-50 dark:bg-[#16233F] shadow-sm transition-all" data-path="pricing" href="#">
<span className="">Explore Pricing &amp; Calculator</span>
</a>
</div>
{/*  Live Trust Assurance Line  */}
<div className="flex flex-wrap items-center gap-y-2 gap-x-6 pt-space-sm font-mono text-xs text-slate-900 dark:text-white"><span className="inline-flex items-center gap-1"><span className="w-2 h-2 rounded-full bg-amber-600 dark:bg-amber-500"></span> SOC 2 Type II In-Progress</span><span className="inline-flex items-center gap-1"><span className="w-2 h-2 rounded-full bg-amber-600 dark:bg-amber-500"></span> Application-Level Tenant Isolation</span><span className="inline-flex items-center gap-1"><span className="w-2 h-2 rounded-full bg-amber-600 dark:bg-amber-500"></span> Advisory AI with Payload Minimization &amp; Human Approval</span></div>
</div>
</div>
</div>
</section>
