  ...
  return (
    <div className="min-h-screen bg-[#faf8ff] text-[#0d1b36] selection:bg-[#F15E1C]/20 selection:text-[#0d1b36] antialiased flex flex-col justify-between">
      ...
      <main className="flex-1 w-full pt-24 sm:pt-28">
                ...
                <div className="p-6 sm:p-8 rounded-2xl bg-white border border-slate-200 shadow-xl flex flex-col gap-6">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-mono text-xs font-bold text-[#0d1b36]">{pillar.badge}</span>
                    </div>
                  ...
                  <div className="space-y-2">
                    <span className="font-mono text-[10px] text-[#5a4138] uppercase tracking-wider block font-semibold">
                      Core Operational Capabilities
                    </span>
                    <ul className="space-y-1.5 text-xs text-[#0d1b36]">
        ...
        <section className="w-full bg-[#f1f3ff] px-4 sm:px-6 lg:px-8 py-16 sm:py-20 border-b border-slate-200" id="workflow-capabilities">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto mb-12">
              {pillar.features.map((feat, idx) => (
                <div key={idx} className="p-6 rounded-2xl bg-white border border-slate-200 shadow-sm flex items-start gap-4">
                  <div className="p-2.5 rounded-xl bg-[#ffdbcf] text-[#F15E1C] shrink-0 font-mono text-xs font-bold">
                    0{idx + 1}
                  </div>
                  <div>
                    <h3 className="font-bold text-sm text-[#0d1b36] mb-1">Feature Requirement #{idx + 1}</h3>
                    <p className="text-xs text-[#5a4138] leading-relaxed">{feat}</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="max-w-3xl mx-auto p-5 rounded-xl bg-white border border-slate-200 shadow-sm flex items-center gap-4">
              <div className="p-2 rounded-lg bg-[#95f6cb] text-[#00513a] shrink-0">
                <UserCheck className="h-5 w-5" />
              </div>
              <div className="text-xs text-[#0d1b36]">
                <span className="font-bold font-mono uppercase text-[#006c4d] block mb-0.5">HUMAN-GOVERNED PRODUCT BOUNDARY</span>
