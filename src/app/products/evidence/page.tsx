...
<li className="flex items-start gap-2">
<CheckCircle2 className="h-5 w-5 shrink-0" />
<span><strong>External Payload Tracking:</strong> OMNiGRC registers SHA-256 target hashes and external URLs. Any drift or unapproved change is instantly flagged in the structured application event log.</span>
</li>
<li className="flex items-start gap-2">
<CheckCircle2 className="h-5 w-5 shrink-0" />
...
<section className="max-w-7xl mx-auto px-gutter pb-16 md:pb-24 w-full">
<div className="p-8 rounded-2xl bg-slate-900 dark:bg-black text-white shadow-xl"><div className="max-w-3xl mb-8"><div className="inline-flex items-center gap-2 px-space-sm py-1 rounded bg-amber-100 dark:bg-amber-900/40 text-white-fixed font-mono text-xs font-bold mb-space-xs"><Shield className="h-5 w-5 shrink-0" /> ARCHITECTURAL SPECIFICATION: DATA MINIMIZATION</div><h3 className="text-3xl md:text-4xl text-surface-container-lowest font-bold">Payload Isolation &amp; Cryptographic State Verification</h3><p className="text-base text-white font-medium mt-2 leading-relaxed">OMNiGRC never acts as a binary dumping ground. By design, our database stores only pointers, attestations, review timestamps, and cryptographic digest hashes.</p></div><div className="grid grid-cols-1 md:grid-cols-3 gap-6"><div className="p-6 rounded-xl bg-white dark:bg-[#0A111F]/10 backdrop-blur-sm border border-surface-container-lowest/10"><div className="font-mono text-xs text-amber-600 dark:text-amber-500-container font-bold mb-2 uppercase tracking-wide">WHAT OMNiGRC STORES</div><ul className="space-y-1.5 font-mono text-xs text-surface-container-lowest font-medium"><li>• External URIs (s3://, https://, jira://)</li><li>• Target SHA-256 state hashes</li><li>• Reviewer identity &amp; RFC 3339 timestamps</li><li>• Control clause cross-mappings</li><li>• Testing cadence schedules</li></ul></div><div className="p-6 rounded-xl bg-white dark:bg-[#0A111F]/10 backdrop-blur-sm border border-surface-container-lowest/10"><div className="font-mono text-xs text-teal-600 dark:text-teal-400-fixed font-bold mb-2 uppercase tracking-wide">WHAT OMNiGRC NEVER INGESTS</div><ul className="space-y-1.5 font-mono text-xs text-surface-container-lowest font-medium"><li>• Proprietary database backups or raw logs</li><li>• Employee PII or salary documents</li><li>• Customer production payloads</li><li>• Unencrypted file uploads</li><li>• Cloud credential secrets or private keys</li></ul></div><div className="p-6 rounded-xl bg-white dark:bg-[#0A111F]/10 backdrop-blur-sm border border-surface-container-lowest/10"><div className="font-mono text-xs text-surface-container-lowest font-bold mb-2 uppercase tracking-wide">AUDITOR VERIFICATION GUARANTEE</div><p className="text-sm text-white font-medium leading-relaxed">When an auditor checks an artifact, the client-side system resolves the pointer against your authoritative source and validates the registered SHA-256 hash. If source data changes without a corresponding review sign-off, OMNiGRC alerts both parties.</p></div></div></div>
</section>
...
<p className="text-base text-slate-600 dark:text-slate-300">
              Strictly no. OMNiGRC operates on an external reference and pointer architecture. Your evidence remains inside your customer-governed AWS, Okta, Jira, or GitHub environments. We track URIs, hashes, and reviewer attestations.
            </p>
</div>
...
<p className="text-base text-slate-600 dark:text-slate-300">
              External auditors are granted access to your scoped, read-only Auditor Workpaper Portal. They review authenticated metadata, SHA-256 validation logs, and custodian sign-offs without needing direct AWS or Okta credentials.
            </p>
</div>
