    ...
    <div className="min-h-screen bg-[#faf8ff] text-[#0d1b36] selection:bg-[#F15E1C]/20 selection:text-[#0d1b36] antialiased flex flex-col justify-between">
      ...
      <main className="pt-32 pb-24 flex-1 flex items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto px-4 text-center">
          <div className="flex h-20 w-20 items-center justify-center rounded-full bg-[#ffdbcf] text-[#380d00] mx-auto mb-8 border border-[#F15E1C]/30 shadow-md">
            <CheckCircle2 className="h-10 w-10 text-[#F15E1C] stroke-[2.5]" />
          </div>

          <h1 className="text-3xl sm:text-5xl font-extrabold text-[#0d1b36] tracking-tight leading-tight mb-4">
            Demo Request Received!
          </h1>

          <p className="text-[#5a4138] text-base sm:text-lg leading-relaxed mb-8 font-medium">
          ...
          <div className="p-6 rounded-2xl border border-slate-200 bg-white mb-8 text-left space-y-3 shadow-sm">
            ...
            <ul className="text-xs text-[#5a4138] space-y-2">
              <li className="flex items-center gap-2">
                <CheckCircle2 className="h-4 w-4 text-[#006c4d] shrink-0" />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link
              href="/resources"
              className="w-full sm:w-auto rounded-xl border border-slate-200 bg-white px-8 py-3.5 text-sm font-bold text-[#0d1b36] hover:bg-slate-50 transition-all flex items-center justify-center gap-2"
            >
