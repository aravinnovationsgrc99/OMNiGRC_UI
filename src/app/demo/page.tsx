          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-6 space-y-8">
              <div>
                ...
                <h2 className="text-2xl sm:text-3xl text-[#0d1b36] font-bold tracking-tight">
                  Tailored Technical Walkthrough
                </h2>
                <p className="text-sm text-[#5a4138] mt-2 leading-relaxed">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={idx} className="flex items-start gap-3 p-3 rounded-xl bg-[#f1f3ff] border border-slate-200">
                    <div className="p-1 rounded-full bg-[#ffdbcf] text-[#380d00] shrink-0 mt-0.5">
                      <CheckCircle2 className="h-4 w-4 text-[#F15E1C]" />
                    </div>
                    <span className="text-[#0d1b36] text-xs font-semibold leading-relaxed">{benefit}</span>
                  </div>
                ))}
              </div>

              {/* Product Truth Boundary Notice */}
              <div className="p-5 rounded-2xl bg-[#faf8ff] border border-slate-200 flex items-start gap-3">
            ...
            <div className="lg:col-span-6">
              <div className="rounded-3xl border border-slate-200 bg-[#f1f3ff] p-8 sm:p-10 shadow-xl">
                <h3 className="text-2xl font-bold text-[#0d1b36] mb-2">Request Your Demo Walkthrough</h3>
                <p className="text-xs text-[#5a4138] mb-6">Fill in your details and a GRC specialist will connect to coordinate a personalized session.</p>

                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    <label className="block text-xs font-semibold text-[#0d1b36] mb-1">Full Name *</label>
                    <input
                      type="text"
                      placeholder="e.g. Alex Morgan"
                      value={formData.name}
                      onChange={(e) => setFormData({ ...formData, name: e.target.value })}
                      className={`w-full rounded-xl border bg-white px-4 py-3 text-sm text-[#0d1b36] placeholder-slate-400 focus:outline-none focus:ring-2 ${
                        errors.name
                          ? "border-red-500 focus:ring-red-500"
                          : "border-slate-200 focus:border-[#F15E1C] focus:ring-[#F15E1C]/20"
                      }`}
                    />
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-[#0d1b36] mb-1">Work Email *</label>
                    <input
                      type="email"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-xs font-semibold text-[#0d1b36] mb-1">Company Name *</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-xs font-semibold text-[#0d1b36] mb-1">Phone Number</label>
                      <input
                        type="tel"
                        placeholder="+1 (555) 000-0000"
                        value={formData.phone}
                        onChange={(e) => setFormData({ ...formData, phone: e.target.value })}
                        className="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm text-[#0d1b36] placeholder-slate-400 focus:border-[#F15E1C] focus:outline-none focus:ring-2 focus:ring-[#F15E1C]/20"
                      />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-xs font-semibold text-[#0d1b36] mb-1">Your Role</label>
                      <select
                        value={formData.role}
                        onChange={(e) => setFormData({ ...formData, role: e.target.value })}
                        className="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm text-[#0d1b36] focus:border-[#F15E1C] focus:outline-none focus:ring-2 focus:ring-[#F15E1C]/20"
                      >
                    ...
                    <div>
                      <label className="block text-xs font-semibold text-[#0d1b36] mb-1">Company Size</label>
                      <select
                        value={formData.size}
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-[#0d1b36] mb-1">Target Frameworks or Priorities</label>
                    <textarea
                      rows={3}
                  ...
                  <div className="flex items-start gap-2.5 pt-2">
                    ...
                    />
                    <label htmlFor="agree" className="text-xs text-[#5a4138] leading-relaxed">
