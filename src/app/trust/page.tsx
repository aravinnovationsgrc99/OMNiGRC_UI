  ...
  return (
    <div className="min-h-screen bg-[#faf8ff] text-[#0d1b36] selection:bg-[#F15E1C]/20 selection:text-[#0d1b36] antialiased flex flex-col justify-between">
      ...
      <main className="flex-1 w-full pt-24 sm:pt-28">
        ...
        <section className="w-full bg-white px-4 sm:px-6 lg:px-8 py-16 sm:py-20 border-b border-slate-200">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {/* Pillar 1 */}
              <div className="p-6 rounded-2xl bg-[#f1f3ff] border border-slate-200 shadow-sm flex flex-col justify-between">
                <div>
                  <div className="p-3 rounded-xl bg-white w-fit border border-slate-200 text-[#F15E1C] mb-4">
                    <Lock className="h-6 w-6" />
                  </div>
                  <h3 className="text-lg font-bold text-[#0d1b36] mb-2">Application-Level Tenant Isolation</h3>
                ...
                <div className="pt-3 border-t border-slate-200">
                  <span className="font-mono text-[11px] text-[#006c4d] font-semibold flex items-center gap-1">
              ...
              <div className="p-6 rounded-2xl bg-[#f1f3ff] border border-slate-200 shadow-sm flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-lg font-bold text-[#0d1b36] mb-2">Advisory AI Data Minimization</h3>
                  <p className="text-xs text-[#5a4138] leading-relaxed mb-4">
              ...
              <div className="p-6 rounded-2xl bg-[#f1f3ff] border border-slate-200 shadow-sm flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-lg font-bold text-[#0d1b36] mb-2">Human-in-the-Loop Governance</h3>
                  <p className="text-xs text-[#5a4138] leading-relaxed mb-4">
              ...
              <div className="p-6 rounded-2xl bg-[#f1f3ff] border border-slate-200 shadow-sm flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-lg font-bold text-[#0d1b36] mb-2">External Evidence Index Model</h3>
                  <p className="text-xs text-[#5a4138] leading-relaxed mb-4">
              ...
              <div className="p-6 rounded-2xl bg-[#f1f3ff] border border-slate-200 shadow-sm flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-lg font-bold text-[#0d1b36] mb-2">Event & Audit Traceability</h3>
                  <p className="text-xs text-[#5a4138] leading-relaxed mb-4">
              ...
              <div className="p-6 rounded-2xl bg-[#f1f3ff] border border-slate-200 shadow-sm flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-lg font-bold text-[#0d1b36] mb-2">Containerized Deployment Options</h3>
                  <p className="text-xs text-[#5a4138] leading-relaxed mb-4">
        ...
        <section className="w-full bg-[#f1f3ff] px-4 sm:px-6 lg:px-8 py-16 sm:py-20 border-b border-slate-200">
          <div className="max-w-7xl mx-auto">
            <div className="text-center max-w-3xl mx-auto mb-12">
              <span className="font-mono text-xs text-[#F15E1C] font-bold uppercase tracking-widest">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12">
              ...
              <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm flex flex-col justify-between">
                <div>
                  <div className="flex items-center justify-between mb-3">
                    <span className="px-2.5 py-1 rounded-full bg-[#ffdbcf] text-[#380d00] font-mono text-[10px] font-bold">
                      MSSP_SHARED
                    </span>
                    <Building2 className="h-4 w-4 text-[#F15E1C]" />
                  </div>
                  <h3 className="text-xl font-bold text-[#0d1b36] mb-2">Shared Multi-Tenant SaaS</h3>
                  <p className="text-xs text-[#5a4138] leading-relaxed mb-4">
                ...
                <ul className="space-y-2 text-xs text-[#0d1b36] pt-4 border-t border-slate-100">
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="h-3.5 w-3.5 text-[#006c4d]" /> Application-level workspace isolation
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="h-3.5 w-3.5 text-[#006c4d]" /> Managed maintenance & schema migrations
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-xl font-bold text-[#0d1b36] mb-2">Dedicated Single-Tenant Instance</h3>
                  <p className="text-xs text-[#5a4138] leading-relaxed mb-4">
                ...
                <ul className="space-y-2 text-xs text-[#0d1b36] pt-4 border-t border-slate-100">
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="h-3.5 w-3.5 text-[#006c4d]" /> Isolated application instance
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="h-3.5 w-3.5 text-[#006c4d]" /> MSSP multi-client context switching
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-xl font-bold text-[#0d1b36] mb-2">Customer-Controlled Docker Runtime</h3>
                  <p className="text-xs text-[#5a4138] leading-relaxed mb-4">
                ...
                <ul className="space-y-2 text-xs text-[#0d1b36] pt-4 border-t border-slate-100">
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="h-3.5 w-3.5 text-[#006c4d]" /> Containerized Docker deployment
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="h-3.5 w-3.5 text-[#006c4d]" /> Internal infrastructure control
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="p-5 rounded-xl bg-white border border-slate-200 text-xs text-[#5a4138] leading-relaxed max-w-4xl mx-auto">
              <strong className="text-[#0d1b36] font-semibold block mb-1">Self-Hosted Deployment Specification:</strong>
        ...
        <section className="w-full bg-white px-4 sm:px-6 lg:px-8 py-16 border-b border-slate-200">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* What We Support */}
              <div className="p-6 rounded-2xl bg-[#faf8ff] border border-slate-200">
                <h3 className="text-base font-bold text-[#006c4d] mb-4 flex items-center gap-2">
                  <CheckCircle2 className="h-5 w-5" /> What OMNiGRC Delivers
                </h3>
                <ul className="space-y-3 text-xs text-[#0d1b36]">
                  <li className="flex items-start gap-2">
                    <span className="text-[#006c4d] font-bold">•</span>
              ...
              <div className="p-6 rounded-2xl bg-[#fff5f2] border border-[#ffdbcf]">
                <h3 className="text-base font-bold text-[#D4521A] mb-4 flex items-center gap-2">
                  <AlertCircle className="h-5 w-5" /> Non-Supported Marketing Overstatements
                </h3>
                <ul className="space-y-3 text-xs text-[#380d00]">
                  <li className="flex items-start gap-2">
                    <span className="text-[#D4521A] font-bold">•</span>
