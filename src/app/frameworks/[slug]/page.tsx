    ...
    <div className="min-h-screen bg-[#faf8ff] text-[#0d1b36] selection:bg-[#F15E1C]/20 selection:text-[#0d1b36] antialiased flex flex-col justify-between">
      ...
      <main className="flex-1 w-full pt-24 sm:pt-28">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <nav className="flex items-center gap-2 text-xs font-mono text-[#5a4138]">
            ...
            <ChevronRight className="h-3 w-3 opacity-50" />
            <span className="text-[#0d1b36] font-semibold">{fw.name}</span>
          </nav>
        </div>

        {/* HERO SECTION */}
        <section className="relative w-full px-4 sm:px-6 lg:px-8 pt-4 pb-12 overflow-hidden border-b border-slate-200">
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-7">
              <div className="flex flex-wrap items-center gap-2 mb-4">
                <span className="px-3 py-1 rounded-full bg-[#ffdbcf] text-[#380d00] font-mono text-xs font-bold uppercase">
                  {fw.badge}
                </span>
                <span className="px-3 py-1 rounded-full bg-white text-[#0d1b36] font-mono text-xs font-bold uppercase border border-slate-200">
                  {fw.region}
                </span>
              </div>

              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#0d1b36] tracking-tight mb-4">
                {fw.name} Framework Guide
              </h1>

              <p className="font-mono text-sm text-[#F15E1C] font-semibold mb-3">
                {fw.headerDesc}
              </p>

              <p className="text-base sm:text-lg text-[#5a4138] leading-relaxed mb-6">
                {fw.desc}
              </p>

              {/* Citations Preview Pill */}
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white border border-slate-200 shadow-sm mb-8">
                <span className="font-mono text-xs text-[#5a4138] font-medium">Selected Framework Citations:</span>
                <div className="flex items-center gap-1.5">
                  {fw.citations.map((c, idx) => (
                    <span key={idx} className="px-2 py-0.5 rounded bg-[#ffdbcf] text-[#380d00] font-mono text-xs font-semibold">
                      {c}
                    </span>
                  ))}
                </div>
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                <Link
                  href="/frameworks"
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-xl font-semibold text-[#0d1b36] bg-white border border-slate-200 hover:bg-slate-50 transition-all text-sm"
                >
            ...
            <div className="lg:col-span-5 flex justify-center">
              <div className="w-full max-w-md p-6 rounded-2xl bg-white border border-slate-200 shadow-xl relative overflow-hidden">
                ...
                <div className="mt-6 pt-4 border-t border-slate-100 text-center">
                  <span className="font-mono text-xs text-[#006c4d] font-semibold flex items-center justify-center gap-1.5">
        ...
        <section className="w-full bg-white px-4 sm:px-6 lg:px-8 py-12 sm:py-16 border-b border-slate-200">
          <div className="max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#f1f3ff] text-[#0d1b36] font-mono text-xs font-bold uppercase mb-4">
              <BookOpen className="h-3.5 w-3.5 text-[#F15E1C]" /> Framework Overview
            </div>
            <h2 className="text-2xl sm:text-3xl font-bold text-[#0d1b36] tracking-tight mb-4">
              What is {fw.name}?
            </h2>
            <p className="text-base text-[#5a4138] leading-relaxed mb-6 font-normal">
              {fw.whatItIs}
            </p>

            <div className="p-4 rounded-xl bg-[#f1f3ff] border border-slate-200 flex items-start gap-3">
              <Info className="h-5 w-5 text-[#F15E1C] shrink-0 mt-0.5" />
              <p className="text-xs text-[#0d1b36] leading-relaxed">
        ...
        <section className="w-full bg-[#f1f3ff] px-4 sm:px-6 lg:px-8 py-12 sm:py-16 border-b border-slate-200">
          <div className="max-w-5xl mx-auto">
            <div className="text-center max-w-2xl mx-auto mb-10">
              <span className="font-mono text-xs text-[#F15E1C] font-bold uppercase tracking-widest">
                TARGET APPLICABILITY
              </span>
              <h2 className="text-2xl sm:text-3xl text-[#0d1b36] font-bold mt-2">
                Who Needs {fw.name}?
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {fw.applicability.map((item, idx) => (
                <div key={idx} className="p-5 rounded-xl bg-white border border-slate-200 shadow-sm flex items-start gap-3">
                  <div className="p-1.5 rounded-lg bg-[#ffdbcf] text-[#380d00] shrink-0 mt-0.5">
                    <CheckCircle2 className="h-4 w-4 text-[#F15E1C]" />
                  </div>
                  <p className="text-sm text-[#0d1b36] font-medium leading-relaxed">{item}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="w-full bg-white px-4 sm:px-6 lg:px-8 py-12 sm:py-16 border-b border-slate-200">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="mb-10">
              <h3 className="font-mono text-xs text-[#0d1b36] uppercase font-bold tracking-wider mb-4 text-center">
                Primary Control Domains (`controlDomains`)
              </h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {fw.controlDomains.map((domain, idx) => (
                  <div key={idx} className="p-5 rounded-2xl bg-[#f1f3ff] border border-slate-200 shadow-sm">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <h4 className="font-mono text-xs font-bold text-[#0d1b36] uppercase">{domain}</h4>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {fw.controls.map((ctrl, idx) => (
                  <div key={idx} className="p-4 rounded-xl bg-[#faf8ff] border border-slate-200 flex items-start gap-3">
                    <FileCheck2 className="h-5 w-5 text-[#006c4d] shrink-0 mt-0.5" />
                    <p className="text-xs font-semibold text-[#0d1b36] leading-relaxed">{ctrl}</p>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {fw.implementationPath.map((step) => (
                <div key={step.step} className="p-6 rounded-2xl bg-white border border-slate-200 shadow-sm relative">
                  <span className="font-mono text-2xl font-extrabold text-[#F15E1C]/30 absolute top-4 right-4">
                    {step.step}
                  </span>
                  <div className="flex items-center gap-2 mb-3">
                    <span className="px-2.5 py-0.5 rounded bg-[#ffdbcf] text-[#380d00] font-mono text-xs font-bold">
                      STEP {step.step}
                    </span>
                  </div>
                  <h3 className="text-base font-bold text-[#0d1b36] mb-2">{step.title}</h3>
                  <p className="text-xs text-[#5a4138] leading-relaxed">{step.description}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              {fw.commonMistakes.map((mistake, idx) => (
                <div key={idx} className="p-4 rounded-xl bg-[#fff5f2] border border-[#ffdbcf] flex items-start gap-3">
                  <AlertTriangle className="h-5 w-5 text-[#D4521A] shrink-0 mt-0.5" />
                  <p className="text-xs text-[#380d00] font-medium leading-relaxed">{mistake}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="w-full bg-[#0d1b36] text-white px-4 sm:px-6 lg:px-8 py-16 border-b border-slate-800">
          <div className="max-w-5xl mx-auto">
            <div className="text-center max-w-3xl mx-auto mb-10">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#ffdbcf] text-[#380d00] font-mono text-xs font-bold uppercase mb-4">
        ...
        <section className="w-full bg-white px-4 sm:px-6 lg:px-8 py-12 sm:py-16 border-b border-slate-200">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="text-2xl sm:text-3xl text-[#0d1b36] font-bold mt-2 mb-4">
              Supported Citations &amp; References
            </h2>
            <p className="text-xs sm:text-sm text-[#5a4138] max-w-2xl mx-auto mb-8">
              Every mapping suggestion in OMNiGRC is anchored directly to published standard taxonomies.
            </p>

            <div className="flex flex-wrap justify-center gap-4">
              {fw.citations.map((c, idx) => (
                <div key={idx} className="px-6 py-4 rounded-xl bg-[#f1f3ff] border border-slate-200 flex items-center gap-3">
                  <BookOpen className="h-5 w-5 text-[#F15E1C]" />
                  <div className="text-left">
                    <span className="font-mono text-xs font-bold text-[#0d1b36] block">Clause {c}</span>
                    <span className="text-[10px] text-[#5a4138]">Standard Reference</span>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="space-y-4">
              {fw.faqs.map((faq, idx) => (
                <div key={idx} className="p-6 rounded-2xl bg-white border border-slate-200 shadow-sm">
                  <h3 className="text-sm sm:text-base font-bold text-[#0d1b36] mb-2 flex items-start gap-2">
                    <span className="text-[#F15E1C] font-mono">Q.</span>
                    <span>{faq.question}</span>
                  </h3>
                  <p className="text-xs sm:text-sm text-[#5a4138] leading-relaxed pl-6">
                    {faq.answer}
                  </p>
                </div>
              ))}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {fw.relatedWorkflows.map((rel, idx) => (
                <Link
                  key={idx}
                  href={rel.href}
                  className="p-5 rounded-2xl bg-[#f1f3ff] border border-slate-200 hover:border-[#F15E1C]/40 hover:shadow-md transition-all group flex flex-col justify-between"
                >
                  <div>
                    <h3 className="text-base font-bold text-[#0d1b36] group-hover:text-[#F15E1C] transition-colors flex items-center justify-between mb-2">
                      <span>{rel.title}</span>
                      <ChevronRight className="h-4 w-4 text-[#5a4138] group-hover:translate-x-1 transition-transform" />
                    </h3>
                    <p className="text-xs text-[#5a4138] leading-relaxed">{rel.description}</p>
                  </div>
                </Link>
              ))}
            </div>
